...
void PlayerStats::Draw()
{
	...
	UIHelpers::DrawSprite(eSprite::Health_Pip, Vector2(10.0, 115.0));
	UIHelpers::DrawRectangle(Vector2(10.0, 115.0), Vector2(360.0, 35.0), Vector4(0.0, 0.0, 0.0, 0.5));
	std::string hp = "HP";
	UIHelpers::DrawAlignedText(hp.c_str(), Vector2(10.0, 115.0), HorizontalAlignment::Center, VerticalAlignment::Center, Colors::White);
}