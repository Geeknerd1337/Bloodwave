...
void MiniBossStats::DrawHealthBar() {
	...
	UIHelpers::DrawStatBar(pos, size, 250.0f, 100.0f, Vector4(255 / 255.0, 235 / 255.0f, 87 / 255.0f, 1.0f));
	UIHelpers::DrawStatBar(pos, size, 250.0f, 100.0f, Vector4(90 / 255.0, 197 / 255.0f, 79 / 255.0f, 1.0f));
}